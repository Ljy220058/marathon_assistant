...
The benchmark evidence directory is \texttt{docs/paper\_project/benchmark\_kb\_v0.2}. It contains 45 verified evidence items reused across the 90 answerable questions. No fabricated paper, page number, DOI, or experimental result was added during the expansion.
