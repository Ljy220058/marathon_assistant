...
- `main.tex`: LNCS-adapted review manuscript entry point.
...
- Local Windows paths: not present in the review manuscript source except this README's local build command.
...
- Main figure remains `figures/figure1_method_workflow.png`.
- Appendix tables remain in `appendix/appendix_tables.tex` as supplementary material.
- Final local verification produced `build/main.pdf` as a 16-page LNCS PDF.
