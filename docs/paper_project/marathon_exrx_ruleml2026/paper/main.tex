...
The artifact package is prepared for public release at
\url{https://github.com/Ljy220058/marathon_assistant}. It includes benchmark
files, rules, schemas, reference runner, evaluator, baselines, traces, figures,
a static trace viewer, and reproducibility scripts. Code will be released under
MIT; synthetic data and documentation under CC BY 4.0. Detailed reproducibility
