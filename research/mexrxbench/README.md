...
Open the static reviewer trace inspector directly in a browser:
...
The inspector includes embedded examples for R2 bounded repair, R3 fail-closed
refusal, and R0 explain-only behavior. It is intended for trace inspection and
does not expose evaluator-only labels as solver inputs.
