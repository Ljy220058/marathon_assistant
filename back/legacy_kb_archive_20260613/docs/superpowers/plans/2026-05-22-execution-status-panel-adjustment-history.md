...
- `docs/architecture/marathon_agent_technical_requirements_v3.md`: `/feedback`, `training_event_feedback`, medical-risk fail-closed, planned load proxy.
...
- [ ] Agent 1: Update `docs/architecture/marathon_agent_technical_requirements_v3.md` with the status aggregation contract, deterministic risk rules, and the `llm_general_knowledge` explanation boundary.
