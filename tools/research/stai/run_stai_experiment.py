...
RUNNER_BY_SYSTEM = {
    "S0": PROJECT_ROOT / "tools" / "research" / "stai" / "run_stai_s0_norag.py",
    "S1": PROJECT_ROOT / "tools" / "research" / "stai" / "run_stai_s1_vanilla_rag.py",
    "S3": PROJECT_ROOT / "tools" / "research" / "stai" / "run_stai_s3_full_workflow.py",
}
